    ...
    function init(){ 
		if( ($(window).width() <= 767)  ) {
	        myMap = new ymaps.Map("map", {
		            center: [42.88032841844546, 74.655230482521],
		            zoom: 14
		        }); 
		} else {
	        myMap = new ymaps.Map("map", {
        ...
        myPlacemark = new ymaps.Placemark([42.88032841844546, 74.655230482521], {
            hintContent: 'Бишкек',
            balloonContent: 'г. Бишкек, рынок Таатан'
        });
